...
```bash
bitasmbl pull --repoUrl https://github.com/he1snber8/Bitasmbl_she-wanna-be-kim-innit_b88_409 --appId 409 --repoId 233
```

## 3) Enter into the main directory and start coding!

```bash
cd Bitasmbl_she-wanna-be-kim-innit_b88_409
```
